...
export default function NewsCardMini({ news }: NewsCardProps) {
    ...
    return (
        ...
        >
            <div className="p-4 mt-5 text-cwhite-1 bg-cgray-2 border border-cgray-2 rounded-lg bg-filter z-10 overflow-hidden text-xs">
                <div className="flex items-start justify-between gap-4 mb-4">
                    <h3 className="news-title text-sm font-bold group-hover:text-cyan-1/70 transition-colors duration-300 line-clamp-2 flex-1">
                        {news.title}
                    </h3>
                    {news.tag == "Новость" ? (
                    ...
                    <div className="news-author flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="news-date text-xs text-gray-400">
                                {formatForumDateSimple(news.date)}
                            </span>
                        </div>
                    </div>
